...
def main():
    ...
    for input_file in range(len(parameters.gff)):
        ...
        if os.path.exists(transcriptome_gff):
            print(transcriptome_gff + " exists, it will be used for aligning the reads, if the file does not result "
        ...
        if not parameters.cutdir:
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=None) as executor:
                for size in kmer:
                    executor.submit(Mapper.cut_reads, size, riboseq_file, adapt, riboseq_name, cutdir)
            # for size in kmer:
        ...
        if "B" in options:
            ...
            print("The name and path of the counting file is expected to be :"
                  "{}/kmer_n/{}_kmer_n_phasing_reads.tab with n the size of the reads".format(cutdir, riboseq_name))
...
main()
# BAM2Reads(".", "R2", "Saccer3_transcriptome.gff", [28, 28], "phasing")
# Mapper.reads_periodicity(28, "R2", ".", "phasing", "start")
# Mapper.reads_periodicity(28, "R2", ".", "phasing", "stop")